	...
	class test extends atoum\test
	{
		...
		public function test__construct()
		{
			$this
				...
				->then
					->object($dependencies = $test->getDepedencies())->isInstanceOf('mageekguy\atoum\dependencies')
					->object($test->getScore())->isEqualTo(new atoum\score($dependencies))
				...
				->and($dependencies['mageekguy\atoum\tests\units\emptyTest']['score'] = $score = new atoum\score())
				->and($dependencies['mageekguy\atoum\tests\units\emptyTest']['locale'] = $locale = new atoum\locale())
				->and($dependencies['mageekguy\atoum\tests\units\emptyTest']['adapter'] = $adapter = new atoum\adapter())
				->and($test = new emptyTest($dependencies))
				->then
					->object($test->getDepedencies())->isIdenticalTo($dependencies['mageekguy\atoum\tests\units\emptyTest'])
		...
		public function testSetDepedencies()
		{
			$this
				->if($test = new emptyTest())
				->then
					->object($test->setDepedencies($dependencies = new atoum\dependencies()))->isIdenticalTo($test)
					->object($testDepedencies = $test->getDepedencies())->isIdenticalTo($dependencies['mageekguy\atoum\tests\units\emptyTest'])
				...
				->if($dependencies = new atoum\dependencies())
				->and($dependencies['mageekguy\atoum\tests\units\emptyTest']['locale'] = $localeInjector = function() {})
				->and($dependencies['mageekguy\atoum\tests\units\emptyTest']['adapter'] = $adapterInjector = function() {})
				->and($dependencies['mageekguy\atoum\tests\units\emptyTest']['score'] = $scoreInjector = function() {})
				->and($dependencies['mageekguy\atoum\tests\units\emptyTest']['includer'] = $includerInjector = function() {})
				->and($dependencies['mageekguy\atoum\tests\units\emptyTest']['reflection\class'] = $reflectionClassInjector = function() {})
				->and($dependencies['mageekguy\atoum\tests\units\emptyTest']['reflection\method'] = $reflectionMethodInjector = function() {})
				->and($dependencies['mageekguy\atoum\tests\units\emptyTest']['annotations\extractor'] = $annotationExtractorInjector = function() {})
				->and($dependencies['mageekguy\atoum\tests\units\emptyTest']['assertion\manager'] = $assertionManagerInjector = function() {})
				->and($dependencies['mageekguy\atoum\tests\units\emptyTest']['asserter\generator'] = $asserterGeneratorInjector = function() {})
				->and($dependencies['mageekguy\atoum\tests\units\emptyTest']['mock\generator'] = $mockGeneratorInjector = function() {})
				->and($dependencies['mageekguy\atoum\tests\units\emptyTest']['engines\concurrent'] = $concurrentEngineInjector = function() {})
				->and($dependencies['mageekguy\atoum\tests\units\emptyTest']['engines\isolate'] = $isolateEngineInjector = function() {})
				->and($dependencies['mageekguy\atoum\tests\units\emptyTest']['engines\inline'] = $inlineEngineInjector = function() {})
				->then
					->object($test->setDepedencies($dependencies))->isIdenticalTo($test)
					->object($testDepedencies = $test->getDepedencies())->isIdenticalTo($dependencies['mageekguy\atoum\tests\units\emptyTest'])
		...
		public function testEnableCodeCoverage()
		{
			$this
				->assert('Code coverage must be enabled only if xdebug is available')
					...
					->and($dependencies['mageekguy\atoum\tests\units\emptyTest']['adapter'] = $adapter)
					->and($test = new emptyTest($dependencies))
					->then
