...
class generator extends atoum\test
{
	...
	public function test__construct()
	{
		$this
			...
			->if($dependencies['locale'] = $locale = new atoum\locale())
	...
	public function testRun()
	{
		$this
			...
			->and($dependencies['phar'] = function($dependencies) use (& $phar) {
					...
					return ($phar = new \mock\phar($dependencies->file));
				}
			)
			...
			->if($dependencies['phar'] = function($dependencies) use (& $phar) {
					$pharController = new mock\controller();
					$pharController->__construct = function() {};
					$pharController->setStub = function() {};
					$pharController->setMetadata = function() {};
