	...
	public function test__construct()
	{
		$this
			...
			->then
				...
				->variable($runner->getDefaultReportTitle())->isNull()
				->array($runner->getObservers())->isEmpty()
			->if($resolver['score'] = $score = new atoum\runner\score())
			...
			->and($resolver['directoryIterator'] = $testDirectoryIterator = new atoum\iterators\recursives\directory())
			->and($resolver['globIteratorResolver'] = $globIteratorResolver = new dependencies\resolver(function() {}))
			->and($resolver['reflectionClassResolver'] = $reflectionClassResolver = new dependencies\resolver(function($resolver) { return new \reflectionClass($resolver['@class']); }))
