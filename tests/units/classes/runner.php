...
class runner extends atoum\test
{
	...
	public function test__construct()
	{
		$this
			...
			->if($resolver['adapter'] = $adapter = new atoum\adapter())
			->if($resolver['locale'] = $locale = new atoum\locale())
			->if($resolver['includer'] = $includer = new atoum\includer())
			->if($resolver['directory\iterator'] = $testDirectoryIterator = new atoum\iterators\recursives\directory())
