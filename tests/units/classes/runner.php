...
class runner extends atoum\test
{
	...
	public function test__construct()
	{
		$this
			...
			->then
				...
				->object($dependencies = $runner->getDepedencies())->isInstanceOf('mageekguy\atoum\dependencies')
				->boolean(isset($dependencies['adapter']))->isTrue()
				->boolean(isset($dependencies['locale']))->isTrue()
				->boolean(isset($dependencies['includer']))->isTrue()
				->boolean(isset($dependencies['score']))->isTrue()
				->boolean(isset($dependencies['glob\iterator']))->isTrue()
				->boolean(isset($dependencies['directory\iterator']))->isTrue()
				->boolean(isset($dependencies['reflection\class']))->isTrue()
				->boolean(isset($dependencies['observers\storage']))->isTrue()
				->boolean(isset($dependencies['reports\storage']))->isTrue()
			...
			->if($runner = new atoum\runner($dependencies = new atoum\dependencies()))
			->then
				->object($runner->getScore())->isInstanceOf('mageekguy\atoum\score')
				->object($runner->getAdapter())->isInstanceOf('mageekguy\atoum\adapter')
				->object($runner->getLocale())->isInstanceOf('mageekguy\atoum\locale')
				->object($runner->getIncluder())->isInstanceOf('mageekguy\atoum\includer')
				->object($runner->getTestDirectoryIterator())->isInstanceOf('mageekguy\atoum\iterators\recursives\directory')
				->object($runner->getDepedencies())->isIdenticalTo($dependencies['mageekguy\atoum\runner'])
				->boolean(isset($dependencies['mageekguy\atoum\runner']['adapter']))->isTrue()
				->boolean(isset($dependencies['mageekguy\atoum\runner']['locale']))->isTrue()
				->boolean(isset($dependencies['mageekguy\atoum\runner']['includer']))->isTrue()
				->boolean(isset($dependencies['mageekguy\atoum\runner']['score']))->isTrue()
				->boolean(isset($dependencies['mageekguy\atoum\runner']['glob\iterator']))->isTrue()
				->boolean(isset($dependencies['mageekguy\atoum\runner']['directory\iterator']))->isTrue()
				->boolean(isset($dependencies['mageekguy\atoum\runner']['reflection\class']))->isTrue()
				->boolean(isset($dependencies['mageekguy\atoum\runner']['observers\storage']))->isTrue()
				->boolean(isset($dependencies['mageekguy\atoum\runner']['reports\storage']))->isTrue()
				->variable($runner->getRunningDuration())->isNull()
				->boolean($runner->codeCoverageIsEnabled())->isTrue()
				->variable($runner->getDefaultReportTitle())->isNull()
				->array($runner->getObservers())->isEmpty()
			->if($dependencies = new atoum\dependencies())
			->and($dependencies['mageekguy\atoum\runner']['adapter'] = $adapterInjector = function() use (& $adapter) { return $adapter = new atoum\adapter(); })
			->and($dependencies['mageekguy\atoum\runner']['locale'] = $localeInjector = function() use (& $locale) { return $locale = new atoum\locale(); })
			->and($dependencies['mageekguy\atoum\runner']['includer'] = $includerInjector = function() use (& $includer) { return $includer = new atoum\includer(); })
			->and($dependencies['mageekguy\atoum\runner']['score'] = $scoreInjector = function() use (& $score) { return $score = new atoum\score(); })
			->and($dependencies['mageekguy\atoum\runner']['directory\iterator'] = $directoryIteratorInjector = function() use (& $directoryIterator) { return $directoryIterator = new atoum\iterators\recursives\directory(); })
			->and($runner = new atoum\runner($dependencies))
			->then
				...
				->object($runner->getDepedencies())->isIdenticalTo($dependencies['mageekguy\atoum\runner'])
				->object($dependencies['mageekguy\atoum\runner']['adapter'])->isIdenticalTo($adapterInjector)
				->object($dependencies['mageekguy\atoum\runner']['locale'])->isIdenticalTo($localeInjector)
				->object($dependencies['mageekguy\atoum\runner']['includer'])->isIdenticalTo($includerInjector)
				->object($dependencies['mageekguy\atoum\runner']['score'])->isIdenticalTo($scoreInjector)
				->object($dependencies['mageekguy\atoum\runner']['directory\iterator'])->isIdenticalTo($directoryIteratorInjector)
				->variable($runner->getRunningDuration())->isNull()
				->boolean($runner->codeCoverageIsEnabled())->isTrue()
				->variable($runner->getDefaultReportTitle())->isNull()
				->array($runner->getObservers())->isEmpty()
	...
	public function testSetDepedencies()
	{
		$this
			->if($runner = new atoum\runner())
			->then
				->object($runner->setDepedencies($dependencies = new atoum\dependencies()))->isIdenticalTo($runner)
				->object($runner->getDepedencies())->isIdenticalTo($dependencies['mageekguy\atoum\runner'])
				->boolean(isset($dependencies['mageekguy\atoum\runner']['adapter']))->isTrue()
				->boolean(isset($dependencies['mageekguy\atoum\runner']['locale']))->isTrue()
				->boolean(isset($dependencies['mageekguy\atoum\runner']['includer']))->isTrue()
				...
				->boolean(isset($dependencies['mageekguy\atoum\runner']['observers\storage']))->isTrue()
				->boolean(isset($dependencies['mageekguy\atoum\runner']['reports\storage']))->isTrue()
			->if($dependencies['mageekguy\atoum\runner']['adapter'] = $adapterInjector = function() {})
			->and($dependencies['mageekguy\atoum\runner']['locale'] = $localeInjector = function() {})
			->and($dependencies['mageekguy\atoum\runner']['includer'] = $includerInjector = function() {})
			->and($dependencies['mageekguy\atoum\runner']['score'] = $scoreInjector = function() {})
			->and($dependencies['mageekguy\atoum\runner']['glob\iterator'] = $globIteratorInjector = function() {})
			->and($dependencies['mageekguy\atoum\runner']['directory\iterator'] = $directoryIteratorInjector = function() {})
			->and($dependencies['mageekguy\atoum\runner']['reflection\class'] = $reflectionClassInjector = function() {})
			->and($dependencies['mageekguy\atoum\runner']['observers\storage'] = $observersStorageInjector = function() {})
			->and($dependencies['mageekguy\atoum\runner']['reports\storage'] = $reportsStorageInjector = function() {})
			->then
				->object($runner->setDepedencies($dependencies))->isIdenticalTo($runner)
				->object($runnerDepedencies = $runner->getDepedencies())->isIdenticalTo($dependencies['mageekguy\atoum\runner'])
