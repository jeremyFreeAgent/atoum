...
class runner extends atoum\test
{
	...
	public function test__construct()
	{
		$this
			...
			->and($resolver['globIterator\resolver'] = function() {})
			->and($resolver['reflection\class\resolver'] = function($resolver) { return new \reflectionClass($resolver['@class']); })
			...
			->then
				...
				->object($runner->getGlobIteratorResolver())->isIdenticalTo($resolver['globIterator\resolver'])
				->object($runner->getReflectionClassResolver())->isIdenticalTo($resolver['reflection\class\resolver'])
				->object($test = $testResolver(array('test' => __CLASS__)))->isInstanceOf(__CLASS__)
