...
class dependencies extends atoum\test
{
	...
	public function testOffsetSet()
	{
		$this
			...
			->then
				...
				->object($dependencies->offsetSet($otherKey, $otherDepedencies = new atoum\dependencies()))->isIdenticalTo($dependencies)
					->boolean(isset($dependencies[$key]))->isTrue()
					->object($dependencies[$key])->isIdenticalTo($injector)
					->boolean(isset($dependencies[$otherKey]))->isTrue()
					->object($dependencies[$otherKey])->isIdenticalTo($otherDepedencies)
		;
	}
	...
	public function testOffsetGet()
	{
		$this
			...
			->if($dependencies['mageekguy\atoum\test'] = $testDepedencies = new atoum\dependencies())
			->then
				->object($dependencies[$this])->isIdenticalTo($testDepedencies)
		;
	}
